...
export default function Experience(){
    return <Page style={{alignItems: 'center', justifyContent: 'center'}}>
        <div style={{display: 'flex', flexDirection: 'row', maxWidth: 1024,width:'100%'}}>
            <div>
                <div style={{
                    display: 'flex',
            ...
            <div style={{display: 'flex', flexDirection: 'column'}}>
                <div style={{display: "flex", flexDirection: 'row', gap: '2rem', position: 'relative'}}>
                    <div>
                        <div style={{whiteSpace: 'nowrap', fontWeight: 700, position: 'sticky', top: '5rem'}}>2009 -
                            current
                        </div>
                    </div>
                    <div style={{display: 'flex', flexDirection: 'column'}}>
                        <div style={{fontSize: '1.1rem', fontWeight: 600}}>Front End Architect / Fullstack
                            Engineer
                        </div>
